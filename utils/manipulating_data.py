...
def get_cleaned_data(columns_to_be_used_as_input, column_to_be_used_as_output):
    ...
    # INPUT DATA
    executions = pd.read_csv("data/input/receita_federal_executions.csv",thousands=',')
    operations = pd.read_csv("data/input/receita_federal _operations.csv", thousands=',')
    instances = pd.read_csv("data/input/receita_federal_instances.csv", thousands=',')
